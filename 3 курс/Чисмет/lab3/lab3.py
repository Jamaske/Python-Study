...
print("\n2 digits\n")
Gaus(3, 4, source=copy(data_FP2), ans=correct_ans, chose=False).solve()
print("\n4 digits\n")
Gaus(3, 4, source=copy(data_FP4), ans=correct_ans, chose=False).solve()
print("\n6 digits\n")
Gaus(3, 4, source=copy(data_FP6), ans=correct_ans, chose=False).solve()


print("===Gaus with chose===")
print("\n2 digits\n")
Gaus(3, 4, source=data_FP2, ans=correct_ans, chose=True).solve()
print("\n4 digits\n")
Gaus(3, 4, source=data_FP4, ans=correct_ans, chose=True).solve()
print("\n6 digits\n")
Gaus(3, 4, source=data_FP6, ans=correct_ans, chose=True).solve()
